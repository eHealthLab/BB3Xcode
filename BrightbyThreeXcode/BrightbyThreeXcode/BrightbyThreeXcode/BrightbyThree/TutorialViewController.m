...
-(void) viewDidLoad
{
    ...
    /*
     ...
     DKCircleButton *profileButton;
     profileButton = [[DKCircleButton alloc] initWithFrame:CGRectMake(250, 0, 90, 90)];
     //profileButton.center = CGPointMake(160, 200);
     profileButton.titleLabel.font = [UIFont systemFontOfSize:22];
     
     [profileButton setTitleColor:[UIColor colorWithWhite:1 alpha:1.0] forState:UIControlStateNormal];
     [profileButton setTitleColor:[UIColor colorWithWhite:1 alpha:1.0] forState:UIControlStateSelected];
     [profileButton setTitleColor:[UIColor colorWithWhite:1 alpha:1.0] forState:UIControlStateHighlighted];
...
-(void) loadView {
    ...
    [tutorialTableView insertSections:[NSIndexSet indexSetWithIndex:0] withRowAnimation:UITableViewRowAnimationTop];
    [tutorialTableView insertSections:[NSIndexSet indexSetWithIndex:1] withRowAnimation:UITableViewRowAnimationTop];
    
    [tutorialTableView insertSections:[NSIndexSet indexSetWithIndex:2] withRowAnimation:UITableViewRowAnimationTop];
