...
#import "LibraryStartViewController.h"
#import "AppDelegate.h"

@implementation LibraryStartViewController
{
...
- (void)viewDidLoad
{
    ...
    self.pageViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"LibraryPageViewController"];
    
    
    self.pageViewController.dataSource = self;
    
    
    LibraryPageContentViewController *startingViewController = [self viewControllerAtIndex:0];
...
- (LibraryPageContentViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    LibraryPageContentViewController *pageContentViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"LibraryPageContentViewController"];
...
{
    NSUInteger index = ((LibraryPageContentViewController*) viewController).pageIndex;
